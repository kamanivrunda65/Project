    ...
    <div class="user-panel-main-bar ">
        ...
        <div class="user-panel mb-30px pt-30px border-top border-top-gray">
            <ul class="generic-list-item generic-list-item-bullet">
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->web_link}}</a></li>
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->facebook_link}}</a></li>
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->twitter_link}}</a></li>
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->insta_link}}</a></li>
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->github_link}}</a></li>
                <li class="pl-3"><a href="#" class="d-inline-block">{{$userbyid->youtube_link}}</a></li>
            </ul>
        </div><!-- end user-panel -->
        <div class="user-panel mb-30px">
            <div class="row">
...
<div class="tab-pan fade" id="user-blog" role="tabpanel" aria-labelledby="user-blog-tab">
    <div class="user-panel-main-bar  ">
        <div class="user-panel mb-40px">
...
<div class="tab-pan fade" id="user-question" role="tabpanel" aria-labelledby="user-blog-tab">
    <div class="user-panel-main-bar">
        <div class="user-panel mb-30px">
            <div class="bg-gray p-3 rounded-rounded d-flex align-items-center justify-content-between">
...
<div class="tab-pan fade" id="user-answer" role="tabpanel" aria-labelledby="user-blog-tab">
    <div class="user-panel-main-bar ">
