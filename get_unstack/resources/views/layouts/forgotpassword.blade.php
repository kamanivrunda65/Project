...
<section class="recovery-area pt-80px pb-80px position-relative">
    <div class="container">
        <form method="post" class="card card-item login-form" id="forgotpassword">
            @csrf
            <div class="card-body row p-0">
                <div class="col-lg-6">
                    <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                        <img src="{{URL::asset('assets/images/undraw-forgot-password.svg')}}" alt="Image" class="img-fluid">
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            ...
                            <p class="pt-3">Forgot your account's password or having trouble logging into your Account? Don't worry, we'll help you to get back your account. Enter your email address and we'll send you a recovery link to reset your password.</p>
                        </div>
                        <div class="form-group">
...
@push('forgot-password')
    <script>
        $('form#forgotpassword').submit(function(event){
            ...
            $.ajax({
                url:'http://localhost:8000/api/sendpasswordmail',
                type:'POST',
                data:formData,
