...
<div class="container">
            ...
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    ...
                    <div class="social-icon-box">
                        ...
                        <a href="/login/google"><button class="btn theme-btn google-btn d-flex align-items-center justify-content-center w-100 mb-2" type="button">
    ...
    <p class="text-black text-center fs-15">Forgot password <a href="{{route('forgotpassword')}}" class="text-color hover-underline">Click here</a></p>
</div><!-- end container -->
</section>
<!--======================================
    END LOGIN AREA
